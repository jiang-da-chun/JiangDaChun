<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseInforList.aspx.cs"
    Inherits="NetworkEducation.Admin.CourseInforList" %>
...
<body>
    ...
    <div id="list">
        <div id="nav-list">
            <a onclick="return OpenEdit(this);" w="800" h="500" href="AddCourseIndro.aspx">添加信息</a>
            | <a href="#" onclick="DeleteSelected('CourseIndro');">批量删除</a> | <a href="#" onclick="slideToggle();">
                搜索</a>
        </div>
        <div id="search">
        ...
        <asp:Repeater ID="rptMessage" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a onclick="return OpenEdit(this);" w="800" h="500" href="ModifyCourseInfor.aspx?id=<%#Eval("id").ToString() %>">
