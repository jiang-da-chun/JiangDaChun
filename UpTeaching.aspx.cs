...
{
    public partial class UpTeaching : System.Web.UI.Page
    {
        public int Tupid;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Tupid = int.Parse(dt.Rows[0]["ID"].ToString());//给Teaching表的外键赋值
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            //数据入库
            string sql = @"INSERT INTO [Teaching]
                                   ([Title]
                                   ,[Tupid]
                                   ,[LinkContent]
                                   ,[TitleColor])
