...
namespace NetworkEducation
{
    ...
    public partial class Teaching : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select count(*) from Teaching";
            ...
            sql = @"select *
                    ...
                    (
	                    ...
	                    from
	                    (
		                    select Teaching.ID,Title,PostTime,ViewCount,LinkContent,TitleColor,NickName
		                    from Teaching,UserInfor
                            where Tupid= UserInfor.ID
	                     )as t1 
                    )AS t2
