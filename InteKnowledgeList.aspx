<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="InteKnowledgeList.aspx.cs" Inherits="NetworkEducation.InteKnowledgeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <div id="main">
        <div id="answer">
            ...
            <div id="location">
                <p>
                    您当前的位置：<a href="Index.htm">首页</a> >>在线学习 >> 课程学习列表</p>
            </div>
            <div id="logo">
                <div id="logo-question">
                    <div id="logo-answer">     
                        <span id="answerContent">
                            <%=Session["UserType"].ToString()=="1" ?"【<a href='UpInteKnowledge.aspx'>上传文件</a>】" : ""%></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <asp:Repeater ID="rptKnowledge" runat="server">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        <a href="InteKnowledgeContent.aspx?cid=<%#Eval("ID") %>" style="color: <%#Eval("TitleColor").ToString()%>">
