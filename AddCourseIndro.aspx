<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" CodeBehind="AddCourseIndro.aspx.cs"
    Inherits="NetworkEducation.Admin.AddCourseIndro" %>
    ...
    <div id="edit">
        <table id="courseInfo">
            ...
            <tr>
                ...
                <td id="btn">
                    <asp:Button OnClientClick="UpdateContent();" class="l-button" ID="submit" runat="server" Text="提交" OnClick="submit_Click" /><input
