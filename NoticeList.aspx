<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="NetworkEducation.Admin.NoticeList" %>
...
<body>
    ...
    <div id="list">
        <div id="nav-list">
            <a href="#" onclick="DeleteSelected('Notice');">批量删除</a> | <a href="#" onclick="slideToggle();">
                搜索</a>
        </div>
        <div id="search">
        ...
        <asp:Repeater ID="rptMessage" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="#" onclick="DeleteData(<%#Eval("id").ToString() %>);">
