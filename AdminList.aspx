<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminList.aspx.cs" Inherits="NetworkEducation.Admin.AdminList" %>
...
<body>
    ...
    <div id="list">
        <div id="nav-list">
            <a onclick="return OpenEdit(this);" w="520" h="250" href="AddAdmin.aspx">添加信息</a> | <a href="#" onclick="DeleteSelected('Admin');">
                批量删除</a> | <a href="#" onclick="slideToggle();">搜索</a>
        </div>
        <div id="search">
        ...
        <asp:Repeater ID="rptMessage" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a onclick="return OpenEdit(this);" w="500" h="225" href="ModifyAdminInfor.aspx?id=<%#Eval("id").ToString() %>">
