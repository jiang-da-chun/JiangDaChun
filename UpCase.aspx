<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" CodeBehind="UpCase.aspx.cs" Inherits="NetworkEducation.UpCase" %>
        ...
        <table id="courseInfo">
            ...
            <tr>
                <th>
                    开发方式</th>
                <td>
                    <asp:DropDownList ID="ddlDevelop" runat="server">
                        <asp:ListItem Text="面相结构化" Value="0" Selected="True"></asp:ListItem>
