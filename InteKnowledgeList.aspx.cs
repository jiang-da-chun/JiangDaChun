...
namespace NetworkEducation
{
    ...
    public partial class InteKnowledgeList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select count(*) from InteKnowledge";
            ...
            sql = @"select *
                    ...
                    (
	                    ...
	                    from
	                    (
		                    select InteKnowledge.ID,Title,PostTime,ViewCount,Content,TitleColor,NickName
		                    from InteKnowledge,UserInfor
                            where Kupid= UserInfor.ID
	                     )as t1 
                    )AS t2
            ...
            this.rptKnowledge.DataSource = dt;
            this.rptKnowledge.DataBind();
